...
import ua.kiev.prog.automation.framework.product.test.ForumTest;
import ua.kiev.prog.automation.framework.product.test.LoginTest;
import ua.kiev.prog.automation.framework.product.test.ProfileTest;
